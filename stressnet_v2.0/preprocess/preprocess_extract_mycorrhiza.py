...
inpdir = "/media/akashkoppa/work/gleam_ml/data/input/raw/traits/mycorrhiza"
outdir = "/media/akashkoppa/work/gleam_ml/data/input/processed/traits"
suffix = "short"
ncfile = {"amd"         : (os.path.join(inpdir, "MycDistrAM_current.nc")),
          "emd"         : (os.path.join(inpdir, "MycDistrEM_current.nc")),
          "erd"         : (os.path.join(inpdir, "MycDistrER_current.nc")),
          "nmd"         : (os.path.join(inpdir, "MycDistrNM_current.nc"))
          }
