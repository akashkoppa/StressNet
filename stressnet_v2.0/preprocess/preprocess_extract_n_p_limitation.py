...
inpdir = "/media/akashkoppa/work/gleam_ml/data/input/raw/traits/leaf_traits"
outdir = "/media/akashkoppa/work/gleam_ml/data/input/processed/traits"
suffix = "tall"
ncfile = {"lnc"         : (os.path.join(inpdir, "LNC.nc")),
          "lpc"         : (os.path.join(inpdir, "LPC.nc")),
          "sla"         : (os.path.join(inpdir, "SLA.nc"))
          }
