...
inpdir = "/media/akashkoppa/work/gleam_ml/StressNet/stressnet_v1.0/input/tall_vegetation"
inpdir_traits = "/media/akashkoppa/work/gleam_ml/StressNet/stressnet_v2.0/input/tall_vegetation"

# station
flxnet = {"stn": (os.path.join(inpdir, "sites_tall_vegetation.h5"))} # sites
...
def main():
    ...
    Returns
    -------
    A trained machine learning model with the required stress parameterization
    """
