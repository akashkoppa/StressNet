...
"""
-------------------------------------------------------------------------------
Python Script for Figure 3 (Transpiration Stress (St))
-------------------------------------------------------------------------------
...
reffil = {"ref": os.path.join(inpdir, "st_observed_sites.h5")}
modfil = {"mo1": os.path.join(inpdir, "st_process_sites.h5"),
          "mo2": os.path.join(inpdir, "st_process_sites.h5")}
modmap = {"ref": "FLUXNET",
          "mo1": "GLEAMv35b",
          "mo2": "GLEAMHybrid"}
figmap = {"ref": "FLUXNET",
...
# subset sitdat based on available data
...
# US
mm = 0.0393701
figure = mp.pyplot.figure(figsize =(60*mm,89*mm), linewidth = 0.0)
...
figaxi = figure.add_subplot(1, 1, 1, 
                            projection = ca.crs.AlbersEqualArea(central_longitude =100,
                                                                central_latitude = 45))
figaxi.add_feature(ca.feature.LAND, edgecolor='black', alpha = 1.00, zorder = 2,
                   linewidth = 0.25)
figaxi.add_feature(ca.feature.OCEAN, zorder = 0)
figaxi.coastlines(zorder = 0, linewidth = 0.25)
