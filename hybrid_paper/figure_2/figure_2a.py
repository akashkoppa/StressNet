...
sizmap = {"ref": "FluxSize",
          "mo1": "GLEAMv35bSize",
          "mo2": "GLEAMHybridSize"}
colmap = {"ref": "FluxColor",
          "mo1": "GLEAMv35bColor",
          "mo2": "GLEAMHybridColor"}
...
kgevio.loc[kgevio["Kling-Gupta Efficiency"] < -2.0, "Kling-Gupta Efficiency"] = np.nan
...
figaxi.set_title("Transpiration Stress Factor ($S_t$)", fontsize = 8)
